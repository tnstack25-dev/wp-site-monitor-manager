    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" class="wpsmm-site-editor" id="wpsmm-site-editor">
        ...
        <main class="wpsmm-editor-main">
            <section class="wpsmm-form-panel">
                ...
                <label>URL website <b>*</b><small>Nhập đầy đủ URL bao gồm http:// hoặc https://</small><div class="wpsmm-input-icon"><span class="dashicons dashicons-admin-site-alt3"></span><input name="url" id="wpsmm-site-url" value="<?php echo esc_attr($edit->url ?? ''); ?>" placeholder="https://example.com" required></div></label>
            ...
            <section class="wpsmm-form-panel">
                ...
                <div class="wpsmm-static-frequency"><span class="dashicons dashicons-clock"></span><div><strong>Tần suất kiểm tra</strong><small>Hệ thống đang kiểm tra website mỗi 2 phút.</small></div></div>
            </section>
        ...
        <aside class="wpsmm-editor-aside">
            <section class="wpsmm-summary-panel">
                ...
                <p><span class="dashicons dashicons-clock"></span><b>Tần suất kiểm tra</b><small>2 phút/lần</small></p>
