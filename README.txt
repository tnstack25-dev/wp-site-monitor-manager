...
Deployment:
- Push code to GitHub.
- Create and push a version tag such as v2.2.3.
- The GitHub Actions workflow builds wp-site-monitor-manager.zip and attaches it to the GitHub Release.
...
= 2.2.3 =
- Release ZIP asset now uses the plugin slug only, without the version number in the file name.
